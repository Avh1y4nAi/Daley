    ...
    <header class="navbar">
        <div class="container">
            ...
            <div class="auth-buttons">
                <a href="<%= request.getContextPath()%>/pages/login.jsp" class="btn btn-outline">Login</a>
                <a href="<%= request.getContextPath()%>/pages/register.jsp" class="btn btn-primary active">Register</a>
            </div>
                    ...
                    <form class="auth-form" action = "<%= request.getContextPath() %>/register" method= "post">
                        ...
                        <div class="form-options">
                            <div class="terms-agreement">
                                ...
                                <label for="terms">I agree to the <a href="terms.html">Terms of Service</a> and <a
